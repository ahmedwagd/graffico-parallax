  ...
  return (
    ...
    >
      <div className="max-w-3xl w-full px-4 mx-auto flex flex-col items-center">
        ...
        <form
          className="contact-elem w-full flex flex-col gap-4 mb-16"
        ...
        >
          ...
          <textarea
            ...
            className="w-full bg-[#1a1a1a] border border-[#2a2a2a] rounded-lg px-5 py-4 text-sm text-gray-300 focus:outline-none focus:border-[#dbbc53] transition-colors resize-none"
          />
          <button
            type="submit"
