    ...
    >
      <div className="max-container w-full px-4 md:px-6 lg:px-12 mx-auto flex flex-col lg:flex-row gap-16 lg:gap-8 items-start">
        ...
        <div className="scale-cards-grid w-full lg:w-1/2 grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mt-8 lg:mt-0">
          <div className="scale-card bg-[#1A1A1A] border border-white/5 rounded-2xl p-6 md:p-8 flex flex-col gap-4">
            ...
            <p className="font-sans text-sm md:text-base text-white/50 leading-relaxed">
              A cutting-edge web presence that commands attention and builds
              lasting trust.
            </p>
          </div>
          ...
          <div className="scale-card bg-[#1A1A1A] border border-white/5 rounded-2xl p-6 md:p-8 flex flex-col gap-4">
            ...
            <p className="font-sans text-sm md:text-base text-white/50 leading-relaxed">
              Eliminate errors and recover valuable hours by automating
          ...
          <div className="scale-card bg-[#1A1A1A] border border-white/5 rounded-2xl p-6 md:p-8 flex flex-col gap-4">
            ...
            <p className="font-sans text-sm md:text-base text-white/50 leading-relaxed">
              Build processes ready to scale without the immediate need for
          ...
          <div className="scale-card bg-[#1A1A1A] border border-white/5 rounded-2xl p-6 md:p-8 flex flex-col gap-4">
            ...
            <p className="font-sans text-sm md:text-base text-white/50 leading-relaxed">
              Interconnected tools and a dedicated team supporting you before,
