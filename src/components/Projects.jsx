...
const LaptopMockup = ({ children, className = "" }) => (
  <div className={`relative z-10 ${className}`}>
    ...
    <div className="w-85 md:w-127.5 lg:w-170 h-2.5 md:h-4 bg-[#d4d4d4] rounded-b-lg md:rounded-b-2xl -ml-5 md:-ml-7.5 lg:-ml-10 relative shadow-2xl">
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-16 md:w-24 h-1 md:h-2 bg-[#A0A0A0] rounded-b-md" />
    </div>
  </div>
);
...
const PhoneMockup = ({ children, className = "" }) => (
  <div className={`relative z-20 ${className}`}>
    <div className="w-35 md:w-45 lg:w-55 aspect-[1/2.1] bg-[#111] rounded-3xl md:rounded-4xl border-4 md:border-[6px] border-[#2a2a2a] relative overflow-hidden shadow-2xl">
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-16 md:w-20 h-4 md:h-5 bg-[#2a2a2a] rounded-b-2xl z-20" />
      <div className="w-full h-full relative z-10 bg-white">{children}</div>
      <div className="absolute bottom-1 md:bottom-2 left-1/2 -translate-x-1/2 w-10 md:w-16 h-1 bg-white/50 rounded-full z-20" />
    </div>
  </div>
);

const FloatIcon = ({ path, className }) => (
  <svg
    className={`absolute float-icon text-(--color-brand-red) ${className}`}
    viewBox="0 0 24 24"
    fill="none"
    stroke="currentColor"
    strokeWidth="2"
...
const ICON_PATHS = [
  ...
  "M3 21l1.65-3.8a9 9 0 1 1 3.4 2.9L3 21z",
  "M13.5 10.5L21 3M16 3h5v5M21 16v3a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h3",
...
const FLOAT_CLASSES = [
  "w-8 h-8 md:w-12 md:h-12 top-[30%] left-[20%] -rotate-12",
  "w-6 h-6 md:w-10 md:h-10 top-[25%] left-[30%] rotate-12",
  "w-10 h-10 md:w-14 md:h-14 top-[35%] right-[25%] -rotate-6",
  "w-8 h-8 md:w-12 md:h-12 top-[45%] right-[15%] rotate-12",
  "w-8 h-8 md:w-12 md:h-12 bottom-[30%] right-[20%] -rotate-12",
  "w-10 h-10 md:w-14 md:h-14 bottom-[20%] right-[30%] rotate-6",
  "w-6 h-6 md:w-10 md:h-10 bottom-[30%] left-[25%] rotate-12",
  "w-8 h-8 md:w-12 md:h-12 bottom-[20%] left-[35%] -rotate-12",
  "w-10 h-10 md:w-16 md:h-16 top-[45%] left-[15%] rotate-12",
];
...
const Projects = () => {
  ...
  useGSAP(
    () => {
      ...
      const wrapper = container.current.querySelector(
        ".horizontal-scroll-wrapper",
      );
      const scrollContainer = container.current.querySelector(
      ...
      container.current.querySelectorAll(".parallax-layer").forEach((el) => {
      ...
      <div className="horizontal-scroll-container w-full h-screen flex items-center overflow-hidden bg-[#E8DAD0]">
        <div className="horizontal-scroll-wrapper relative flex flex-nowrap items-center h-full w-max z-10">
          ...
          <div className="relative w-screen h-screen shrink-0 flex flex-col items-center justify-center px-4 z-40 bg-[#E8DAD0]">
            ...
            <div className="absolute bottom-12 left-1/2 -translate-x-1/2 flex flex-col items-center gap-4">
              ...
              <div className="w-6 h-10 border-2 border-[#101011] rounded-full flex justify-center p-1 opacity-50">
                <div className="w-1.5 h-1.5 bg-(--color-brand-red) rounded-full animate-bounce" />
              </div>
            </div>
          </div>
          ...
          <div className="absolute inset-y-0 left-[100vw] w-full pointer-events-none z-0">
            {GHOST_WORDS.map(({ text, className, speed }) => (
              <GhostText
                key={text}
                text={text}
                className={className}
          ...
          <div className="project-cluster relative w-[80vw] md:w-[60vw] lg:w-200 shrink-0 min-h-[500px] flex items-center justify-center ml-[10vw]">
            <div className="relative flex items-center justify-center w-full mt-12">
              <LaptopMockup
                ...
                data-speed="0.1"
              >
                <div className="w-full h-full bg-[#111] p-4 text-white text-xs relative flex flex-col items-center justify-center border-t border-white/5">
                  ...
                  <div className="flex gap-4">
                    <div className="w-16 md:w-24 h-8 bg-white/10 rounded-full" />
                    <div className="w-16 md:w-24 h-8 border border-white/20 rounded-full" />
                  </div>
                </div>
              </LaptopMockup>
              ...
              >
                <div className="w-full h-full bg-white text-black p-4 md:p-6 flex flex-col items-center relative">
                  ...
                  <h3 className="text-center font-serif text-[11px] md:text-sm italic mb-4 leading-relaxed tracking-wide">
                    ...
                    colore superano ogni aspettativa."
                  </h3>
                  <div className="w-1/2 h-px bg-black/20 my-4" />
            ...
            <div className="relative flex items-center justify-center w-full mt-0">
              ...
              >
                <div className="w-full h-full bg-white text-black p-4 flex flex-col relative overflow-hidden">
                  <div className="h-20 md:h-28 bg-slate-100 -mx-4 -mt-4 mb-4 relative overflow-hidden">
                    <img
                ...
                <div className="w-full h-full bg-[#111] text-white flex flex-col relative px-4 pb-0 overflow-hidden">
                  ...
                  <div className="flex-1 mt-6 z-20 relative">
                    ...
                    <p className="text-[8px] md:text-[10px] mt-4 leading-relaxed text-white/50 w-4/5 uppercase tracking-wider">
                      Unisciti a chi sta già facendo la differenza. Insieme,
            ...
            <div className="relative flex items-center justify-center w-full mt-0 z-20">
              ...
              >
                <div className="w-full h-full bg-[#f8f6f0] text-[#111] overflow-hidden relative">
                  <div className="absolute right-0 top-0 w-1/2 h-full bg-[#e8edeb] rounded-bl-[100px] flex flex-col items-center justify-center p-4 xl:p-8">
                    ...
                    <div className="w-8 md:w-12 h-0.5 bg-[#111] mt-4" />
                  </div>
              ...
              >
                <div className="w-full h-full bg-[#f8f6f0] text-[#111] flex flex-col relative px-4 pb-4">
                  ...
                  <div className="bg-[#e8edeb] mt-6 rounded-t-[2rem] h-28 md:h-44 flex items-end justify-center pb-4 w-[calc(100%+2rem)] -ml-4 relative overflow-hidden">
                    <img
